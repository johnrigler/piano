...
midi.load = function() {
 ...
 console.log(position);
   ...
   navigator.requestMIDIAccess().then( x =>
      ...
      // This next part was tricky, there is probably a
...
midi.drawPanic = function drawPanic( t ) {

console.log("drawPanic");

let b = document.createElement("button");

b.setAttribute("name","panic");
b.setAttribute("onclick","midi.stopAll()"):
b.innerHTML = "<h1>Panic (stop all sound)</h1>";
